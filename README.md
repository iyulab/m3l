...
2. **Parsers** — libraries that read `.m3l.md` files and produce a structured AST (Abstract Syntax Tree)
...
| Package | Language | Registry | Path |
|---------|----------|----------|------|
| [@iyulab/m3l](https://www.npmjs.com/package/@iyulab/m3l) | TypeScript | npm | [`parser/typescript/`](parser/typescript/) |
| M3L | C# | NuGet | `parser/csharp/` (planned) |
